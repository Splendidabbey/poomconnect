...
<section class="hero hero-landing">
    ...
    <div class="container hero-grid hero-grid-landing">
        <div class="hero-content">
            <div class="hero-badge">✨ AI-POWERED REAL-TIME MATCHING</div>
            ...
            <div class="hero-features">
                <div class="hero-feature"><span class="hero-feature-icon">🤖</span> AI Matching</div>
                <div class="hero-feature"><span class="hero-feature-icon">⚡</span> Real-time Rounds</div>
                <div class="hero-feature"><span class="hero-feature-icon">📱</span> QR Ticketing</div>
                <div class="hero-feature"><span class="hero-feature-icon">🛡️</span> Safe & Inclusive</div>
            </div>
        </div>
            ...
            <div class="stats-grid">
                <div class="stat-item">
                    <div class="stat-icon stat-icon-purple">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6C35FF" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    </div>
                    <h3>10K+</h3>
                ...
                <div class="stat-item">
                    <div class="stat-icon stat-icon-pink">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FF2D8D" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                    </div>
                    <h3>500+</h3>
                    <p>Events Hosted</p>
                </div>
                <div class="stat-item">
                    <div class="stat-icon stat-icon-purple">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6C35FF" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                    </div>
                    <h3>25K+</h3>
                    <p>Matches Made</p>
                </div>
                <div class="stat-item">
                    <div class="stat-icon stat-icon-pink">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FF2D8D" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                    </div>
                    <h3>98%</h3>
        ...
        <div class="landing-split-grid" id="how-it-works">
            <div class="landing-split-left">
                ...
                <div class="steps-vertical">
                    ...
                    <div class="step-arrow-vertical" aria-hidden="true"></div>
                    <div class="step-row">
                        <div class="step-icon step-icon-pink">💬</div>
                        <div class="step-copy">
                        ...
                        <?php foreach ($upcomingEvents as $event): ?>
                            ...
                            <a href="<?= base_url('event.php?id=' . (int) $event['id']) ?>" class="events-panel-item">
                                ...
                                <div class="events-panel-info">
                                    <h4><?= e($event['title']) ?></h4>
                                    <p><span class="event-meta-icon">📅</span> <?= e(format_date($event['event_date'])) ?> · <?= e(format_time($event['start_time'])) ?></p>
                                    <p><span class="event-meta-icon">📍</span> <?= e($event['location'] ?? 'TBA') ?></p>
                                </div>
                        ...
                        <?php foreach ($demoEvents as $event): ?>
                            <a href="<?= e($event['url']) ?>" class="events-panel-item">
                                ...
                                <div class="events-panel-info">
                                    <h4><?= e($event['title']) ?></h4>
                                    <p><span class="event-meta-icon">📅</span> <?= e(format_date($event['event_date'])) ?> · <?= e(format_time($event['start_time'])) ?></p>
                                    <p><span class="event-meta-icon">📍</span> <?= e($event['location']) ?></p>
                                </div>
            ...
            <div class="dashboard-mockup-layout">
                <aside class="dashboard-mockup-sidebar">
                    <div class="dashboard-mockup-logo">
                        <img src="<?= brand_logo('sm') ?>" alt="Poom Connect">
                    </div>
                    <nav>
                                ...
                                <svg viewBox="0 0 400 100" preserveAspectRatio="none">
                                    <defs>
                                        ...
                                        <linearGradient id="chartFill" x1="0" y1="0" x2="0" y2="1">
                                            <stop offset="0%" stop-color="rgba(108,53,255,0.2)"/>
